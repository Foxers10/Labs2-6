...
namespace Lab2
{
	public class Program
    {
			static void Main(string[] args)
			{
				...
				string str = "да";
                while (str == "да") //проверка нужды в продолжении
				{
					...
					Console.WriteLine("\nВведите значения геометрической фигуры");
                    switch (v) { 
                        ...
                        Rectangle obj1 = new Rectangle(v_rect, w_rect);//создание объекта класса Прямоугольник и передача введеных ранее параметров в конструктор
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        obj1.Print();//печать данных
                        break;
                    case '2':
